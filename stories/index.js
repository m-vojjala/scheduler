...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form name="Lydia-Miller Jones" interviewers={interviewers} value={2} onSave={action("onSave")} onCancel={action("onCancel")} onChange={action("onChange")} />)
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={1}
        time="12pm"
        interview={{ student: "Lydia Miller-Jones", interviewer: "Lydia" }}
      />
      <Appointment id="last" time="1pm" />
    </Fragment>
  ))